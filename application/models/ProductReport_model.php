<?php
  class ProductReport_model extends CI_Model {
    ...
    {      
      ...
      $this->db->select('category_master.categoryId,categoryName'); 
    ...
    {      
      ...
      $this->db->select('company_master.companyId,companyName'); 
    ...
    public function Reportdetails($productName,$categoryName,$companyName,$productcode)
    {
      ...
      {
        $this->db->where('company_master.companyId', $companyName);
      }
